...
class __TwigTemplate_ec83b24479481aa57044e76e453c35f60f836f3e547bbcd7f72b8d22a502db53 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  padding: ";
            // line 188
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["button_padding"] ?? null), 188, $this->source), "html", null, true);
            echo ";
  border-radius: ";
            // line 189
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["button_radius"] ?? null), 189, $this->source), "html", null, true);
            echo "px;
}
";
        }
